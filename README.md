...
*   تولید خودکار مازها با ابعاد متغیر (از $5 \times 5$ در مراحل ابتدایی تا $80 \times 80$ در سطوح پیشرفته) به کمک الگوریتم‌های توسعه‌یافته گراف (DFS).
*   دارای ۱۰۰۰ مرحله پویا و هیجان‌انگیز تقسیم‌شده به دسته‌های سختی گوناگون با چالش‌های منحصر‌به‌فرد.
